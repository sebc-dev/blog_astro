...
export class ThemeManager {
  ...
  private updateThemeIcons(theme: string): void {
    const themeButtons = document.querySelectorAll<HTMLElement>('[data-theme-toggle]');
  ...
  private toggleTheme(): void {
    ...
    const newTheme = current === this.lightTheme ? this.darkTheme : this.lightTheme;
  ...
  public getCurrentTheme(): string {
    return document.documentElement.getAttribute('data-theme') || this.getTheme();
  }
